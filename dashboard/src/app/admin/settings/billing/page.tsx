...
export default function SettingsBillingPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Billing &amp; Connect</h1>
        <p className="mt-1 text-sm text-gray-600">
          Connect a Stripe Express account to sell subscriptions from the mobile app. Platform fees apply per your
          contract.
        </p>
      </div>
